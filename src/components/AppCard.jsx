export function AppCard({ app, onDelete, isOwner }) {
  return (
      ...
      <div className="card-body p-4 gap-2">
        ...
        {app.versions.length > 0 && (
          <div className="flex flex-col gap-1 mt-1">
            <div className="text-xs text-base-content/50 font-semibold uppercase tracking-wide">Downloads</div>
        ...
        {isOwner && onDelete && (
          <div className="card-actions justify-end mt-1">
            <button className="btn btn-ghost btn-xs text-error" onClick={() => onDelete(app.name)}>Delete</button>
          </div>
        )}
      </div>
    </div>
